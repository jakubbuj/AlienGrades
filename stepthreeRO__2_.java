...
public class App{
    ...
    private static ArrayList<Integer> FullList = new ArrayList<>();
    private static ArrayList<Integer> HighList = new ArrayList<>();
    private static ArrayList<Integer> MediumList = new ArrayList<>();
    private static ArrayList<Integer> LowList = new ArrayList<>();
    private static ArrayList<Integer> NothingList = new ArrayList<>();
    //hurni
    private static ArrayList<Integer> NulpList = new ArrayList<>();
    private static ArrayList<Integer> DootList = new ArrayList<>();
    private static ArrayList<Integer> LobiList = new ArrayList<>();
    //suruna
    private static ArrayList<Integer> Lal1List = new ArrayList<>(); // 100 - 90
    private static ArrayList<Integer> Lal2List = new ArrayList<>(); // 89 - 80
    private static ArrayList<Integer> Lal3List = new ArrayList<>(); // 79 - 70
    private static ArrayList<Integer> Lal4List = new ArrayList<>(); // 69 -59
    //lal count
    private static ArrayList<Integer> Stars5List = new ArrayList<>();
    private static ArrayList<Integer> Stars4List = new ArrayList<>();
    private static ArrayList<Integer> Stars3List = new ArrayList<>();
    private static ArrayList<Integer> Stars2List = new ArrayList<>();
    private static ArrayList<Integer> Stars1List = new ArrayList<>();
    ...
    public static void main(String[] args) {
       ...
       String [] [] StudentInfo = {
        ...
        App.IndexArrays(StudentInfo);
        App predictor = new App();
        double expectedGrade = predictor.DecisionStump(1, predictor.current_grades);
  ...
  /** used in other method
    ...
    **/
    ...
    public static void IndexArrays(String [] [] StudentInfo) {

        for (int i = 1; i < StudentInfo.length; i++) {

            final int COLUMN_INDEX_FOR_GRADE = 3;
            int studentGrade = Integer.parseInt(StudentInfo[i][COLUMN_INDEX_FOR_GRADE]);

            if (StudentInfo[i][1].equals("nulp")) {
                NulpList.add(i);
            }
            if (StudentInfo[i][1].equals("nulp")) {
                DootList.add(i);
            }
            if (StudentInfo[i][1].equals("lobi")) {
                LobiList.add(i);
            }

            if (StudentInfo[i][2].equals("full")) {
                FullList.add(i);
            }
            if (StudentInfo[i][2].equals("high")) {
                HighList.add(i);
            }
            if (StudentInfo[i][2].equals("medium")) {
                MediumList.add(i);
            }
            if (StudentInfo[i][2].equals("low")) {
                LowList.add(i);
            }
            if (StudentInfo[i][2].equals("nothing")) {
                NothingList.add(i);
            }
            ...
            if (studentGrade <= 89 && studentGrade >= 80) {
                Lal2List.add(i);
            }
            if (studentGrade <= 79 && studentGrade >= 70) {
                Lal3List.add(i);
            }
            if (studentGrade <= 69 && studentGrade >= 59) {
                Lal4List.add(i);
            }

            if (StudentInfo[i][4].equals("5 stars")) {
                Stars5List.add(i);
            }
            if (StudentInfo[i][4].equals("4 stars")) {
                Stars4List.add(i);
            }
            if (StudentInfo[i][4].equals("3 stars")) {
                Stars3List.add(i);
            }
            if (StudentInfo[i][4].equals("2 stars")) {
                Stars2List.add(i);
            }
            if (StudentInfo[i][4].equals("1 star")) {
                Stars1List.add(i);
            }
        }
    ...
    public double SumDIFF(int Coursenumber,double [] [] current_grades ,String [] [] StudentInfo) {
        ...
        for (int i=0; i<current_grades.length;i++){
                    if (FullList.contains(i)){
                        hisums= hisums+current_grades[i] [Coursenumber];
                        hiinstance2++;
                    }
                    if (NothingList.contains(i)){
                        lowsums=lowsums+current_grades[i] [Coursenumber];
                        lowinstance2++;
                    }
                    if (NulpList.contains(i)){
                        temp1=temp1 + current_grades[i] [Coursenumber];
                    }
                    if (LobiList.contains(i)){
                        temp2=temp2 + current_grades [i] [Coursenumber];
                    }
                    if (Lal1List.contains(i)) {
                        temp3=temp3+ current_grades [i] [Coursenumber];
                    }
                    if (Lal4List.contains(i)) {
                        temp4=temp4+ current_grades [i] [Coursenumber];
                    }
                    if (Stars5List.contains(i)) {
                        temp5=temp5+ current_grades [i] [Coursenumber];
                    }
                    if (Stars1List.contains(i)) {
                        temp6=temp6+ current_grades [i] [Coursenumber];
                    }
                }
        ...
        int Studentnumber=3; //Student number is the number on the left -2
    ...
    public static double calculateExpectedGrade(ArrayList<Integer> studentNumbers, int studentNumber, double[][] currentGrades, int courseNumber) {
        ...
        int instance = 0;
            ...
            for (int i = 0; i < currentGrades.length; i++) {
                if (studentNumbers.contains(i)) {
                    tempSum += currentGrades[i][courseNumber];
                    instance++;
                }
